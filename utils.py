...
from CirilloLearning import load_spiral_csv, load_recfac,run_binary_classification_mc,plot_scatter, plot_confusion_matrix, plot_learning_curve, summary_statistics
...
def run_etapa1_classification_spiral():
    ...
    try:
        ...
        hp_perc = {'lr': 0.01, 'epochs': 1000}
        hp_adaline = {'lr': 0.001, 'epochs': 1000}
        ...
        print(f"\n Executando Validação Monte Carlo (R={R_val}) com 80/20...")
        ...
        for name, config in model_configs.items():
            ...
            results = run_binary_classification_mc(X, y, 
                                                   ...
                                                   R=R_val, 
                                                   test_size=0.2, rng_seed=rng_seed,**model_kwargs)
...
def run_etapa2_multiclass_recfac():
    ...
    try:
        ...
        print(f"\n Executando Validação Monte Carlo (R={R_val}) com 80/20 para Multiclasse...")
